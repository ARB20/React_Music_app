...
class Home extends React.Component{
      ...
      render()
      {
              ...
              return(  
                   <div class="row">
                       <h1 style={{color:"red"}} >Search Music</h1><br></br>
                       <PlayCircleOutlined/>
                        ...
                        <center><div className="row g-2">
                               ...
                               <div class="col-md-4"> 
                                  <Button className="btn btn-primary" icon={<SearchOutlined/>} style={{width:'200px'}} onClick={() => this.searchMusic(this.state.artist)}>Search</Button>
                               </div>
                            </div> </center>
                       <br></br><br></br>
